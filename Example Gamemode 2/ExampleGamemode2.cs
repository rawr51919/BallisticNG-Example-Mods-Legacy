...
{
    public class ExampleGamemode2Register : ModRegister
    {
        public override void OnRegistered()
        {
            /*---Register the gamemode---*/
            GamemodeRegistry.RegisterGamemode("Example Gamemode 2", new ExampleGamemode2(true));
        }
    }
    ...
    public class ExampleGamemode2 : Gamemode
    {
        /* NOTE:
        ...
        public ExampleGamemode2()
        {

        }

        /* This constructor is a wrapper for the default gamemode constructor, this is needed also. */
        public ExampleGamemode2(bool manualConfiguration) : base(manualConfiguration)
        {
        ...
        public override void LoadInterfaces()
        {
            ...
            _eventCompleteInterface = (ScriptableMedalMenu)InterfaceLoader.LoadMenu(InterfaceLoader.Menus.EventCompleteRace, false);
